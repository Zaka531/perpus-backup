        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="table-penerbit">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Kode</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div text-align>
                                        <form action="/penerbit/delete/{{$pene->id}}" id="btn-delete">
                                            <a href="/penerbit/edit/{{$pene->id}}" class="btn btn-warning btn-sm"><i
                                                    class="fas fa-edit"></i> Edit</a>
                                            @csrf
                                            @method('delete')
                                            <button class="btn btn-danger btn-sm" data-id="{{$pene->id}}"
