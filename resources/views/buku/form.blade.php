                ...
                <form action="{{route('buku.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="stok" placeholder="Masukkan Stok" name="stok">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="sinopsis" placeholder="Masukkan Nama Sinopsis"
                                name="sinopsis">
                        </div>
                    </div>
