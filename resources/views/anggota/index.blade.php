                    ...
                    <table class="table table-striped" id="table-anggota">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('/storage/anggota/'.$angg->foto)}}" alt="{{$angg->foto}}"
                                        style="width: 150px"></td>
                                <td>
                                    <div text-align>
                                        <form action="/anggota/delete/{{$angg->id}}" id="btn-delete" method="get">
                                            <a href="/anggota/edit/{{$angg->id}}" class="btn btn-warning btn-sm"><i
